    ...
    <div className="w-[90%] max-w-[1800px] md:w-[70%] m-auto mb-10 uppercase font-medium">
      <div className="md:grid md:grid-cols-3 flex flex-col gap-2 md:grid-rows-2 w-[100%] h-[100%]">
        <div className="col-span-2">
          <div className="bg-[url('/accessori.jpg')] bg-center bg-cover h-[100%] w-full rotate-grid rounded-lg">
        ...
        <div className="row-span-2">
          <div className="bg-[url('/abbigliamento.jpg')] bg-center bg-cover h-full w-full rotate-grid rounded-lg">
        ...
        <div className=" md:w-[23vw] h-full md:h-[24vw]">
          <div className="bg-[url('/uomo.jpg')] bg-center bg-cover md:w-[100%] rotate md:h-[100%] rounded-lg rotate-grid">
        ...
        <div className=" md:w-[23vw] h-full md:h-[24vw]">
          <div className="bg-[url('/donna.jpg')] bg-center bg-cover md:w-[100%] rotate md:h-[100%] rounded-lg rotate-grid">
