  ...
  return (
    <div>
      <div className="m-auto max-w-[350px] h-auto font-clash font-normal text-center mt-20 mb-20">
        ...
        <button className="mt-5 mb-4 flex bg-blueish text-buttontext p-3 w-[80%] gap-3 justify-center items-center border-[2px] border-blueish hover:ease-in transition ease-in-out delay-150 hover:shadow-headline/50 hover:shadow-xl rounded-xl font-satoshi font-bold uppercase tracking-wide mx-auto">
